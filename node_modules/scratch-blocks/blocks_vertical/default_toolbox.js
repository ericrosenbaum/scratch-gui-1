...
Blockly.Blocks.defaultToolbox = '<xml id="toolbox-categories" style="display: none">' +
  ...
  '<category name="Extensions" id="extensions" colour="#FF6680" secondaryColour="#FF4D6A" ' +
    ...
    '<block type="extension_microbit_display" id="extension_microbit_display">' +
      ...
      '</value>' +
    '</block>' +
    '<block type="extension_pisensehat_display" id="extension_pisensehat_display">' +
      '<value name="MATRIX8">' +
        '<shadow type="matrix8">' +
          '<field name="MATRIX8">0101010110101010010101011010101001010101101010100101010110101010</field>' +
        '</shadow>' +
      '</value>' +
    '</block>' +
